public class CompOp {
    ...
    void ParseCompOp() {
        ...
        if (token.equals(">")) {
            cmp = CompSymb.GREATER;
        }
        if (token.equals("<")) {
            cmp = CompSymb.LESS;
        }
        if (token.equals(">=")) {
            cmp = CompSymb.GREATEREQ;
        }
        if (token.equals("<=")) {
            cmp = CompSymb.LESSEQ;
        }
    ...
    void PrintCompOp() {
        if (cmp == CompSymb.NOTEQ) {
            System.out.print("!=");
        }
        if (cmp == CompSymb.EQ) {
            System.out.print("==");
        }
        if (cmp == CompSymb.GREATER) {
            System.out.print(">");
        }
        if (cmp == CompSymb.LESS) {
            System.out.print("<");
        }
        if (cmp == CompSymb.GREATEREQ) {
            System.out.print(">=");
        }
        if (cmp == CompSymb.LESSEQ) {
            System.out.print("<=");
        }
    }
